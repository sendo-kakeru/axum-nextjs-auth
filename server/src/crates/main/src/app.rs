...
use crate::{
    config::connect,
    handler::{
        handle_create_user, // handle_create_circle, handle_debug, handle_fetch_all, handle_fetch_circle,
...
pub(crate) struct AppState {
    ...
    // pub(crate) circle_duplicate_checker: CircleDuplicateCheckerWithMySql,oryWi
}
